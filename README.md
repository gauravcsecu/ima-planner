...
After committing, open the GitHub Pages site URL, not the GitHub file viewer. If an installed PWA still shows an older screen, close it and reload the Pages URL so the v22 service worker can replace older IMA Study caches.


v22 UI update: improved mobile Full form / Short form alignment and stronger light-theme contrast for Import/Export resource controls.
